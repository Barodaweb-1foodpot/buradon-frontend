          ...
          <div className="row clearfix">
            <div className="col-lg-6 col-md-6 col-sm-12 chooseus-block">
              <p className="mb-5">
                ...
                24 years. Specializing in LR , AR and ACS grade chemicals,
                Buradon delivers quality and reliability across its expanding
                product portfolio. With expertise in production, synthesis, and
                purification, Buradon caters to global markets, ensuring prompt
                service and competitive pricing. Trusted by 100+ customers in 2
